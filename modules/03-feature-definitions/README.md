# Module 03: Feature Definitions and Entities
...
- Understand the core concepts of Feature Definitions and Entities
...
### What is Feature Definitions and Entities?

Feature Definitions and Entities is a fundamental component of Feature Store Lab: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Feature Definitions and Entities like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/03-feature-definitions/
```
...
```bash
ls modules/03-feature-definitions/lab/starter/
```
...
cd modules/03-feature-definitions/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/03-feature-definitions/validation/validate.sh
```
...
1. What is the main purpose of Feature Definitions and Entities?
...
**Next: [Module 04 →](../04-offline-store/)**
