# Module 08: Feature Sharing and Discovery
...
- Understand the core concepts of Feature Sharing and Discovery
...
### What is Feature Sharing and Discovery?

Feature Sharing and Discovery is a fundamental component of Feature Store Lab: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Feature Sharing and Discovery like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
```bash
ls modules/08-feature-sharing/lab/starter/
```
...
cd modules/08-feature-sharing/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/08-feature-sharing/validation/validate.sh
```
...
1. What is the main purpose of Feature Sharing and Discovery?
...
**Next: [Module 09 →](../09-real-time-features/)**
